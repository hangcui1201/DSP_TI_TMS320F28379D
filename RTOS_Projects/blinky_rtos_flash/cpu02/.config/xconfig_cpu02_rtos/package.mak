...
override PKGDIR = xconfig_cpu02_rtos
...
package/%.xdc.inc package/%_xconfig_cpu02_rtos.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_cpu02_rtos" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,28FP .dlls: cpu02_rtos.p28FP

-include package/cfg/cpu02_rtos_p28FP.mak
-include package/cfg/cpu02_rtos_p28FP.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/cpu02_rtos_p28FP.dep
endif
cpu02_rtos.p28FP: package/cfg/cpu02_rtos_p28FP.xdl
	@


ifeq (,$(wildcard .libraries,28FP))
cpu02_rtos.p28FP package/cfg/cpu02_rtos_p28FP.c: .libraries,28FP
endif

package/cfg/cpu02_rtos_p28FP.c package/cfg/cpu02_rtos_p28FP.h package/cfg/cpu02_rtos_p28FP.xdl: override _PROG_NAME := cpu02_rtos.x28FP
package/cfg/cpu02_rtos_p28FP.c: package/cfg/cpu02_rtos_p28FP.cfg
package/cfg/cpu02_rtos_p28FP.xdc.inc: package/cfg/cpu02_rtos_p28FP.xdl
package/cfg/cpu02_rtos_p28FP.xdl package/cfg/cpu02_rtos_p28FP.c: .interfaces

clean:: clean,28FP
	-$(RM) package/cfg/cpu02_rtos_p28FP.cfg
	-$(RM) package/cfg/cpu02_rtos_p28FP.dep
	-$(RM) package/cfg/cpu02_rtos_p28FP.c
	-$(RM) package/cfg/cpu02_rtos_p28FP.xdc.inc

clean,28FP::
	-$(RM) cpu02_rtos.p28FP
.executables,28FP .executables: cpu02_rtos.x28FP

cpu02_rtos.x28FP: |cpu02_rtos.p28FP

-include package/cfg/cpu02_rtos.x28FP.mak
cpu02_rtos.x28FP: package/cfg/cpu02_rtos_p28FP.o28FP 
	$(RM) $@
	@$(MSG) lnk28FP $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.C28_float.rootDir)/bin/cl2000 -q -u _c_int00 -z  -o $@ package/cfg/cpu02_rtos_p28FP.o28FP   package/cfg/cpu02_rtos_p28FP.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.C28_float.rootDir)/lib/libc.a
	
cpu02_rtos.x28FP: export C_DIR=
cpu02_rtos.x28FP: PATH:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)
cpu02_rtos.x28FP: Path:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)

cpu02_rtos.test test,28FP test: cpu02_rtos.x28FP.test

cpu02_rtos.x28FP.test:: cpu02_rtos.x28FP
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 cpu02_rtos.x28FP.test
else
	@$(MSG) running $<  ...
	$(call EXEC.cpu02_rtos.x28FP, ) 
endif

clean,28FP::
	-$(RM) $(wildcard .tmp,cpu02_rtos.x28FP,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
cpu02_rtos_p28FP.o28FP,copy : package/cfg/cpu02_rtos_p28FP.o28FP
cpu02_rtos_p28FP.s28FP,copy : package/cfg/cpu02_rtos_p28FP.s28FP

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_cpu02_rtos
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_cpu02_rtos.tar.dep
endif
package/rel/xconfig_cpu02_rtos/xconfig_cpu02_rtos/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_cpu02_rtos/xconfig_cpu02_rtos/package/package.rel.xml: package/build.cfg
package/rel/xconfig_cpu02_rtos/xconfig_cpu02_rtos/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_cpu02_rtos/xconfig_cpu02_rtos/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_cpu02_rtos.tar: package/rel/xconfig_cpu02_rtos.xdc.inc package/rel/xconfig_cpu02_rtos/xconfig_cpu02_rtos/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_cpu02_rtos.xdc.inc,package/rel/xconfig_cpu02_rtos.tar.dep)


release release,xconfig_cpu02_rtos: all xconfig_cpu02_rtos.tar
clean:: .clean
	-$(RM) xconfig_cpu02_rtos.tar
	-$(RM) package/rel/xconfig_cpu02_rtos.xdc.inc
	-$(RM) package/rel/xconfig_cpu02_rtos.tar.dep
