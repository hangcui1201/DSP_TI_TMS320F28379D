...
void main(void) {
   ...
   // This will populate the entire table, even if the __interrupt is not used in this example.  This is useful for debug purposes.
...
// PWM1-3, ECAP1, ECAP2, TZ1-TZ4, SPI-A, EQEP1, SCI-A, I2C and a number of I/O pins
void Gpio_setup1(void) {
...
// PWM1-3, CAP1, CAP2, SPI-A, SPI-B, CAN-A, SCI-A and I2C and a number of I/O pins
void Gpio_setup2(void) {
