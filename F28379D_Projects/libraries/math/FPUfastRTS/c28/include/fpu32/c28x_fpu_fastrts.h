...
//<<VC160921: This block is for documentation purposes only, and not part of 
// the  functional library itself; FOR_DOXYGEN_USE_ONLY is only defined in 
// the Doxyfile under PREDEFINED
// VC160921>>
