...
typedef enum
{
    ...
    DCC_COUNT1SRC_ENET_RXCLK    = 0x7U, //!< etherNET RXCLK Clock Source
    ...
    DCC_COUNT1SRC_ECAT0_RXCLK   = 0xDU, //!< MII0 RXCLK(etherCAT) Clock Source
    DCC_COUNT1SRC_WDCLK         = 0xEU, //!< Watch Dog Clock Source
    DCC_COUNT1SRC_CANX          = 0xFU, //!< CANxBIT Clock Source
    DCC_COUNT1SRC_SYSAPLLCLK     = 0x10U, //!< System APLL Clock Source
    DCC_COUNT1SRC_SYSAPLLVCO     = 0x11U, //!< System APLL Voltage control
    DCC_COUNT1SRC_SYSAPLLVCO_BY2 = 0x12U, //!< System APLL Voltage control
    DCC_COUNT1SRC_SYSAPLLFMDIV   = 0x13U, //!< System APLL FM DIV
    DCC_COUNT1SRC_SYSAPLLFNDIV   = 0x14U, //!< System APLL FN DIV
    DCC_COUNT1SRC_SYSAPLLINTOSC  = 0x15U, //!< System APLL Internal Osc Clk
    DCC_COUNT1SRC_SYSAPLLCLK_AUX = 0x16U, //!< System APLL Aux Clk
    DCC_COUNT1SRC_ECAT1_RXCLK    = 0x17U, //!< MII1 RXCLK(etherCAT) Clk Src
    DCC_COUNT1SRC_AUXAPLLCLK     = 0x18U, //!< Aux APLL Clock Source
    DCC_COUNT1SRC_AUXAPLLVCO     = 0x19U, //!< Aux APLL Voltage control Src
    DCC_COUNT1SRC_AUXAPLLVCO_BY2 = 0x1AU, //!< Aux APLL Voltage control Src
    DCC_COUNT1SRC_AUXAPLLFMDIV   = 0x1BU, //!< Aux APLL FM DIV Source
    DCC_COUNT1SRC_AUXAPLLFNDIV   = 0x1CU, //!< Aux APLL FN DIV Source
    DCC_COUNT1SRC_AUXAPLLINTOSC  = 0x1DU, //!< Aux APLL Internal Osc Clk
    DCC_COUNT1SRC_AUXAPLLCLK_AUX = 0x1EU, //!< Aux APLL Aux Clk Source
...
//! - \b DCC_COUNT1SRC_ENET_RXCLK - etherNET RXCLK Clock Source
...
//! - \b DCC_COUNT1SRC_ECAT0_RXCL - MII0 RXCLK(etherCAT) Clock Source
//! - \b DCC_COUNT1SRC_WDCLK      - Watch Dog Clock Source
//! - \b DCC_COUNT1SRC_CANX       - CANxBIT Clock Source
//! - \b DCC_COUNT1SRC_SYSAPLLCLK     - System APLL Clock Source
//! - \b DCC_COUNT1SRC_SYSAPLLVCO     - System APLL Voltage control
//! - \b DCC_COUNT1SRC_SYSAPLLVCO_BY2 - System APLL Voltage control
//! - \b DCC_COUNT1SRC_SYSAPLLFMDIV   - System APLL FM DIV
//! - \b DCC_COUNT1SRC_SYSAPLLFNDIV   - System APLL FN DIV
//! - \b DCC_COUNT1SRC_SYSAPLLINTOSC  - System APLL Internal Osc Clk
//! - \b DCC_COUNT1SRC_SYSAPLLCLK_AUX - System APLL Aux Clk
//! - \b DCC_COUNT1SRC_ECAT1_RXCLK    - MII1 RXCLK(etherCAT) Clk Src
//! - \b DCC_COUNT1SRC_AUXAPLLCLK     - Aux APLL Clock Source
//! - \b DCC_COUNT1SRC_AUXAPLLVCO     - Aux APLL Voltage control Src
//! - \b DCC_COUNT1SRC_AUXAPLLVCO_BY2 - Aux APLL Voltage control Src
//! - \b DCC_COUNT1SRC_AUXAPLLFMDIV   - Aux APLL FM DIV Source
//! - \b DCC_COUNT1SRC_AUXAPLLFNDIV   - Aux APLL FN DIV Source
//! - \b DCC_COUNT1SRC_AUXAPLLINTOSC  - Aux APLL Internal Osc Clk
//! - \b DCC_COUNT1SRC_AUXAPLLCLK_AUX - Aux APLL Aux Clk Source
//!
//! \return None.
//
//*****************************************************************************
