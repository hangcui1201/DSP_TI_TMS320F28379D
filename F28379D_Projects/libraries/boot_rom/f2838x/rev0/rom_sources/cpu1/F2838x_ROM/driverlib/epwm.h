...
typedef enum
{
    ...
    EPWM_AQ_TRIGGER_EVENT_TRIG_DC_EVTFILT = 8   //!< DC filter event
...
//!
//! \param base is the base address of the EPWM module.
//! \param mode is the sync-in mode.
//!
//! This function enables the sync-out pulse source.
//! Below valid values for mode can be OR'd together to enable multiple
//! sync-out sources:
...
//! Below valid values for mode can be OR'd together to disable multiple
//! sync-out sources:
