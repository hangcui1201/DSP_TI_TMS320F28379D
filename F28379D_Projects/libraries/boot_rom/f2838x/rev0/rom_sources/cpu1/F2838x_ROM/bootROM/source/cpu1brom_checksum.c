...
const composite_checksum_t pbist_csum_rom = {
        0x0004B3FBUL,    //total_ones
        0x0000A9ECUL, 0x00002A20UL, 0x00000000UL,    //bit_column_cksum[0][3];
        0x0000E2C1UL, 0x00003332UL, 0x00000000UL,    //bit_column_cksum[1][3];
        0x0000BA64UL, 0x00003115UL, 0x00000000UL,    //bit_column_cksum[2][3];
        0x00006798UL, 0x00002CACUL, 0x00000000UL,    //bit_column_cksum[3][3];
        0x0000A36EUL, 0x00002862UL, 0x00000000UL,    //bit_column_cksum[4][3];
        0x0000D257UL, 0x000029FDUL, 0x00000000UL,    //bit_column_cksum[5][3];
        0x0000FDECUL, 0x000027ADUL, 0x00000000UL,    //bit_column_cksum[6][3];
        0x00002199UL, 0x00002758UL, 0x00000000UL,    //bit_column_cksum[7][3];
        0x00000000UL, 0x0000000AUL, 0x0000E3CCUL, 0x00006431UL, //row_weight_sum
        0x00000000UL, 0x00002903UL, 0x000014B2UL, 0x00007F05UL  //fact_weight_sum
};
...
const composite_checksum_t csum_rom = {
        0x0018D125UL,    //total_ones
        0x0000F86DUL, 0x000035B7UL, 0x00000003UL,    //bit_column_cksum[0][3];
        0x00009614UL, 0x00005F17UL, 0x00000003UL,    //bit_column_cksum[1][3];
        0x000066FEUL, 0x000058EAUL, 0x00000003UL,    //bit_column_cksum[2][3];
        0x0000E728UL, 0x0000494AUL, 0x00000003UL,    //bit_column_cksum[3][3];
        0x00000C15UL, 0x0000318CUL, 0x00000003UL,    //bit_column_cksum[4][3];
        0x0000BEB0UL, 0x00003B60UL, 0x00000003UL,    //bit_column_cksum[5][3];
        0x00009164UL, 0x00001F87UL, 0x00000003UL,    //bit_column_cksum[6][3];
        0x0000B28CUL, 0x00002624UL, 0x00000003UL,    //bit_column_cksum[7][3];
        0x00000000UL, 0x000000CFUL, 0x00004C7FUL, 0x00000318UL, //row_weight_sum
        0x00000000UL, 0x0000658BUL, 0x0000F403UL, 0x00009733UL  //fact_weight_sum
};
...
verify_pbist_checksum_onROM(void)
{
    ...
    mblock_rom[1].lastAddr =  0x003FD31FUL;
    mblock_rom[1].mem_attribute = 1U;    //data is present

    mblock_rom[2].firstAddr = 0x003FD320UL;
