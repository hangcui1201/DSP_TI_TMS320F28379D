...
#define HRPWM_registerInterrupt               EPWM_registerInterrupt
#define HRPWM_registerTripZoneInterrupt       EPWM_registerTripZoneInterrupt
#define HRPWM_unregisterInterrupt             EPWM_unregisterInterrupt
#define HRPWM_unregisterTripZoneInterrupt     EPWM_unregisterTripZoneInterrupt
