...
//
//*****************************************************************************
#define UDMA_O_DMASRCENDP         0x0U         // DMA Channel Source Address
                                               // End Pointer
#define UDMA_O_DMADSTENDP         0x4U         // DMA Channel Destination
                                               // Address End Pointer
...
#define UDMA_O_DMACTLBASE         0x8U         // DMA Channel Control Base
                                               // Pointer
#define UDMA_O_DMAALTBASE         0xCU         // DMA Alternate Channel Control
                                               // Base Pointer
#define UDMA_O_DMAWAITSTAT        0x10U        // DMA Channel Wait-on-Request
                                               // Status
...
#define UDMA_O_DMAREQMASKCLR      0x24U        // DMA Channel Request Mask
                                               // Clear
#define UDMA_O_DMAENASET          0x28U        // DMA Channel Enable Set
#define UDMA_O_DMAENACLR          0x2CU        // DMA Channel Enable Clear
#define UDMA_O_DMAALTSET          0x30U        // DMA Channel Primary Alternate
                                               // Set
#define UDMA_O_DMAALTCLR          0x34U        // DMA Channel Primary Alternate
                                               // Clear
...
#define UDMA_O_DMACHASGN          0x500U       // DMA Channel Assignment
...
#define UDMA_O_DMAPERIPHID4       0xFD0U       // DMA Peripheral Identification
                                               // 4
#define UDMA_O_DMAPERIPHID0       0xFE0U       // DMA Peripheral Identification
                                               // 0
#define UDMA_O_DMAPERIPHID1       0xFE4U       // DMA Peripheral Identification
                                               // 1
#define UDMA_O_DMAPERIPHID2       0xFE8U       // DMA Peripheral Identification
                                               // 2
#define UDMA_O_DMAPERIPHID3       0xFECU       // DMA Peripheral Identification
                                               // 3
#define UDMA_O_DMAPCELLID0        0xFF0U       // DMA PrimeCell Identification
                                               // 0
#define UDMA_O_DMAPCELLID1        0xFF4U       // DMA PrimeCell Identification
                                               // 1
#define UDMA_O_DMAPCELLID2        0xFF8U       // DMA PrimeCell Identification
                                               // 2
#define UDMA_O_DMAPCELLID3        0xFFCU       // DMA PrimeCell Identification
                                               // 3
...
#define UDMA_DMASTAT_DMACHANS_M   0x1F0000U    // Available DMA Channels Minus
                                               // 1
...
#define UDMA_DMAPERIPHID0_PID0_M  0xFFU        // DMA Peripheral ID Register
                                               // [7:0]
...
#define UDMA_DMAPERIPHID1_PID1_M  0xFFU        // DMA Peripheral ID Register
                                               // [15:8]
...
#define UDMA_DMAPERIPHID2_PID2_M  0xFFU        // DMA Peripheral ID Register
                                               // [23:16]
...
#define UDMA_DMAPERIPHID3_PID3_M  0xFFU        // DMA Peripheral ID Register
                                               // [31:24]
...
#define UDMA_DMAPCELLID0_CID0_M   0xFFU        // DMA PrimeCell ID Register
                                               // [7:0]
...
#define UDMA_DMAPCELLID1_CID1_M   0xFFU        // DMA PrimeCell ID Register
                                               // [15:8]
...
#define UDMA_DMAPCELLID2_CID2_M   0xFFU        // DMA PrimeCell ID Register
                                               // [23:16]
...
#define UDMA_DMAPCELLID3_CID3_M   0xFFU        // DMA PrimeCell ID Register
                                               // [31:24]
#endif
