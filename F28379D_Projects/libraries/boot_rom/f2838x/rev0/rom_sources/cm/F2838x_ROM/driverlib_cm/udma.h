...
//!   mode.
//! - \b UDMA_CH_ATTR_ALTSELECT is used to select the alternate control structure
...
//! - \b UDMA_CH_ATTR_REQMASK is used to mask the hardware request signal from the
