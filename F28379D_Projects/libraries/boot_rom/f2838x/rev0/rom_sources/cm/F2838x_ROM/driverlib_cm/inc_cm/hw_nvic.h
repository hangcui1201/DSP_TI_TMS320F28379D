...
//
//*****************************************************************************
#define NVIC_O_ISER0              0x100U       // NVIC Interrupt Set Enable
                                               // Register 0
#define NVIC_O_ISER1              0x104U       // NVIC Interrupt Set Enable
                                               // Register 1
#define NVIC_O_ICER0              0x180U       // NVIC Interrupt Clear Enable
                                               // Register 0
#define NVIC_O_ICER1              0x184U       // NVIC Interrupt Clear Enable
                                               // Register 1
#define NVIC_O_ISPR0              0x200U       // NVIC Interrupt Set Pending
                                               // Register 0
#define NVIC_O_ISPR1              0x204U       // NVIC Interrupt Set Pending
                                               // Register 1
#define NVIC_O_ISPR2              0x208U       // NVIC Interrupt Set Pending
                                               // Register 2
#define NVIC_O_ICPR0              0x280U       // NVIC Interrupt Clear Pending
                                               // Register 0
#define NVIC_O_ICPR1              0x284U       // NVIC Interrupt Clear Pending
                                               // Register 1
#define NVIC_O_IABR0              0x300U       // NVIC Interrupt Active Bit
                                               // Register 0
#define NVIC_O_IABR1              0x304U       // NVIC Interrupt Active Bit
                                               // Register 1
#define NVIC_O_IPR0               0x400U       // NVIC Interrupt Priority
                                               // Register 0
#define NVIC_O_IPR1               0x404U       // NVIC Interrupt Priority
                                               // Register 1
#define NVIC_O_IPR2               0x408U       // NVIC Interrupt Priority
                                               // Register 2
#define NVIC_O_IPR3               0x40CU       // NVIC Interrupt Priority
                                               // Register 3
#define NVIC_O_IPR4               0x410U       // NVIC Interrupt Priority
                                               // Register 4
#define NVIC_O_IPR5               0x414U       // NVIC Interrupt Priority
                                               // Register 5
#define NVIC_O_IPR6               0x418U       // NVIC Interrupt Priority
                                               // Register 6
#define NVIC_O_IPR7               0x41CU       // NVIC Interrupt Priority
                                               // Register 7
#define NVIC_O_IPR8               0x420U       // NVIC Interrupt Priority
                                               // Register 8
#define NVIC_O_IPR9               0x424U       // NVIC Interrupt Priority
                                               // Register 9
#define NVIC_O_IPR10              0x428U       // NVIC Interrupt Priority
                                               // Register 10
#define NVIC_O_IPR11              0x42CU       // NVIC Interrupt Priority
                                               // Register 11
#define NVIC_O_IPR12              0x430U       // NVIC Interrupt Priority
                                               // Register 12
#define NVIC_O_IPR13              0x434U       // NVIC Interrupt Priority
                                               // Register 13
#define NVIC_O_IPR14              0x438U       // NVIC Interrupt Priority
                                               // Register 14
#define NVIC_O_IPR15              0x43CU       // NVIC Interrupt Priority
                                               // Register 15
#define NVIC_O_STIR               0xF00U       // Software Trigger Interrupt
                                               // Register
#define NVIC_O_ACTLR              0x8U         // Auxiliary Control Register
#define NVIC_O_CPUID              0xD00U       // CPUID Base Register
#define NVIC_O_ICSR               0xD04U       // Interrupt Control and State
                                               // Register
#define NVIC_O_VTOR               0xD08U       // Vector Table Offset Register
#define NVIC_O_AIRCR              0xD0CU       // Application Interrupt and
                                               // Reset Control Register
#define NVIC_O_SCR                0xD10U       // System Control Register
#define NVIC_O_CCR                0xD14U       // Configuration and Control
                                               // Register
#define NVIC_O_SHPR1              0xD18U       // System Handler Priority
                                               // Register 1
#define NVIC_O_SHPR2              0xD1CU       // System Handler Priority
                                               // Register 2
#define NVIC_O_SHPR3              0xD20U       // System Handler Priority
                                               // Register 3
#define NVIC_O_SHCSRS             0xD24U       // System Handler Control and
                                               // State Register
#define NVIC_O_CFSR               0xD28U       // Configurable Fault Status
                                               // Register
#define NVIC_O_HFSR               0xD2CU       // HardFault Status Register
#define NVIC_O_MMFAR              0xD34U       // MemManage Fault Address
                                               // Register
#define NVIC_O_BFAR               0xD38U       // BusFault Address Register
#define NVIC_O_AFSR               0xD3CU       // Auxiliary Fault Status
                                               // Register
#define NVIC_O_MMSR               0xD28U       // MemManage Fault Status
                                               // Register
#define NVIC_O_BFSR               0xD29U       // BusFault Status Register
#define NVIC_O_UFSR               0xD2AU       // UsageFault Status Register
#define NVIC_O_SYST_CSR           0x10U        // Privileged a SysTick Control
                                               // and Status Register
#define NVIC_O_SYST_RVR           0x14U        // Privileged Unknown SysTick
                                               // Reload Value Register
#define NVIC_O_SYST_CVR           0x18U        // Privileged Unknown SysTick
                                               // Current Value Register
#define NVIC_O_SYST_CALIB         0x1CU        // Privileged -a SysTick
...
#define NVIC_O_MPU_RBAR           0xD9CU       // MPU Region Base Address
                                               // Register
#define NVIC_O_MPU_RASR           0xDA0U       // MPU Region Attribute and Size
                                               // Register
...
#define NVIC_STIR_INTID_M         0x1FFU       // Software Trigger Interrupt
                                               // Register.
...
//
//*****************************************************************************
#define NVIC_ACTLR_DISMCYCINT     0x1U         // Disable interruption of
                                               // load/store multiple instruction.
#define NVIC_ACTLR_DISDEFWBUF     0x2U         // Disable write buffer on
                                               // default memory map.
#define NVIC_ACTLR_DISFOLD        0x4U         // Disables IT folding.
#define NVIC_ACTLR_DISFPCA        0x100U       // Disables automatic update of
                                               // CONTROL.FPCA.
...
#define NVIC_ICSR_RETTOBASE       0x800U       // Indicates presence of
                                               // preempted active exceptions.
#define NVIC_ICSR_VECTPENDING_S   12U
#define NVIC_ICSR_VECTPENDING_M   0x3F000U     // Exception number of highest
                                               // priority pending exception.
#define NVIC_ICSR_ISRPENDING      0x400000U    // Interrupt pending flag
#define NVIC_ICSR_PENDSTCLR       0x2000000U   // SysTick exception
                                               // clear-pending bit
#define NVIC_ICSR_PENDSTSET       0x4000000U   // SysTick exception set-pending
                                               // bit.
...
#define NVIC_AIRCR_PRIGROUP_M     0x700U       // Interrupt priority grouping
                                               // field
...
//
//*****************************************************************************
#define NVIC_SCR_SLEEPONEXIT      0x2U         // sleep-on-exit when returning
                                               // from Handler mode.
#define NVIC_SCR_SLEEPDEEP        0x4U         // Sleep/deep sleep low power
                                               // mode.
#define NVIC_SCR_SEVONPEND        0x10U        // Send Event on Pending bit.
...
//
//*****************************************************************************
#define NVIC_CCR_NONBASETHRDENA   0x1U         // Indicates how the processor
                                               // enters Thread mode
#define NVIC_CCR_USERSETMPEND     0x2U         // Enables unprivileged software
                                               // access to the STIR.
#define NVIC_CCR_UNALIGN_TRP      0x8U         // Enables unaligned access
                                               // traps.
#define NVIC_CCR_DIV_0_TRP        0x10U        // faulting/halting on DIV by 0
                                               // exception.
#define NVIC_CCR_BFHFNMIGN        0x100U       // Ignore data BusFaults caused
                                               // by load and store
                                               // instructions.
#define NVIC_CCR_STKALIGN         0x200U       // Indicates stack alignment on
                                               // exception entry.
...
#define NVIC_SHPR1_PRI_4_M        0xE0U        // Priority of system handler 4,
                                               // MemManage
#define NVIC_SHPR1_PRI_5_S        13U
#define NVIC_SHPR1_PRI_5_M        0xE000U      // Priority of system handler 5,
                                               //  BusFault
#define NVIC_SHPR1_PRI_6_S        21U
#define NVIC_SHPR1_PRI_6_M        0xE00000U    // Priority of system handler 6,
                                               // UsageFault
...
#define NVIC_SHPR2_PRI_11_M       0xE0000000U  // Priority of system handler
                                               // 11, SVCall
...
#define NVIC_SHPR3_PRI_14_M       0xE00000U    // Priority of system handler
                                               // 14, PendSV
#define NVIC_SHPR3_PRI_15_S       29U
#define NVIC_SHPR3_PRI_15_M       0xE0000000U  // Priority of system handler
                                               // 15, SysTick exception
...
//
//*****************************************************************************
#define NVIC_SHCSRS_MEMFAULTACT   0x1U         // MemManage exception active
                                               // bit
#define NVIC_SHCSRS_BUSFAULTACT   0x2U         // BusFault exception active bit
#define NVIC_SHCSRS_USGFAULTACT   0x8U         // UsageFault exception active
                                               // bit
...
#define NVIC_SHCSRS_USGFAULTPENDED  0x1000U      // UsageFault exception pending
                                               // bit
#define NVIC_SHCSRS_MEMFAULTPENDED  0x2000U      // MemManage exception pending
                                               // bit
#define NVIC_SHCSRS_BUSFAULTPENDED  0x4000U      // BusFault exception pending
                                               // bit
...
//
//*****************************************************************************
#define NVIC_CFSR_IACCVIOL        0x1U         // Instruction access violation
                                               // flag
#define NVIC_CFSR_DACCVIOL        0x2U         // Data access violation flag
#define NVIC_CFSR_MUNSTKERR       0x8U         // MemManage fault on unstacking
                                               // for a return from exception
#define NVIC_CFSR_MSTKERR         0x10U        // MemManage fault on stacking
                                               // for exception entry
#define NVIC_CFSR_MMARVALID       0x80U        // MemManage Fault Address
                                               // Register (MMFAR) valid flag
...
#define NVIC_CFSR_UNSTKERR        0x800U       // BusFault on unstacking for a
                                               // return from exception
#define NVIC_CFSR_STKERR          0x1000U      // BusFault on stacking for
                                               // exception entry
#define NVIC_CFSR_BFARVALID       0x8000U      // BusFault Address Register
                                               // (BFAR) valid flag
#define NVIC_CFSR_UNDEFINSTR      0x10000U     // Undefined instruction
                                               // UsageFault
...
//
//*****************************************************************************
#define NVIC_HFSR_VECTTBL         0x2U         // BusFault on a vector table
                                               // read.
#define NVIC_HFSR_FORCED          0x40000000U  // Indicates a forced hard fault
#define NVIC_HFSR_DEBUGEVT        0x80000000U  // Indicates a forced DEBUG
                                               // event fault
...
//
//*****************************************************************************
#define NVIC_MMSR_IACCVIOL        0x1U         // Instruction access violation
                                               // flag
#define NVIC_MMSR_DACCVIOL        0x2U         // Data access violation flag
#define NVIC_MMSR_MUNSTKERR       0x8U         // MemManage fault on unstacking
                                               // for a return from exception
#define NVIC_MMSR_MSTKERR         0x10U        // MemManage fault on stacking
                                               // for exception entry
#define NVIC_MMSR_MMARVALID       0x80U        // MemManage Fault Address
                                               // Register (MMFAR) valid flag
...
#define NVIC_BFSR_UNSTKERR        0x8U         // BusFault on unstacking for a
                                               // return from exception
#define NVIC_BFSR_STKERR          0x10U        // BusFault on stacking for
                                               // exception entry
#define NVIC_BFSR_BFARVALID       0x80U        // BusFault Address Register
                                               // (BFAR) valid flag
...
//
//*****************************************************************************
#define NVIC_UFSR_UNDEFINSTR      0x1U         // Undefined instruction
                                               // UsageFault
...
#define NVIC_SYST_CSR_TICKINT     0x2U         // Enables SysTick exception
                                               // request
#define NVIC_SYST_CSR_CLKSOURCE   0x4U         // Indicates the clock source
#define NVIC_SYST_CSR_COUNTFLAG   0x10000U     // timer counted to 0 since last
                                               // read.
...
#define NVIC_SYST_CALIB_SKEW      0x40000000U  // Indicates whether the TENMS
                                               // value is exact
#define NVIC_SYST_CALIB_NOREF     0x80000000U  // Device provides a reference
...
//
//*****************************************************************************
#define NVIC_MPU_TYPE_SEPARATE    0x1U         // unified/separate instruction
                                               // and date memory maps
#define NVIC_MPU_TYPE_DREGION_S   8U
#define NVIC_MPU_TYPE_DREGION_M   0xFF00U      // Indicates the number of
                                               // supported MPU data regions
#define NVIC_MPU_TYPE_IREGION_S   16U
#define NVIC_MPU_TYPE_IREGION_M   0xFF0000U    // Indicates the number of
                                               // supported MPU instruction regions
...
#define NVIC_MPU_CTRL_HFNMIENA    0x2U         // Enables MPU during hard
                                               // fault, NMI, and FAULTMASK handlers.
#define NVIC_MPU_CTRL_PRIVDEFENA  0x4U         // Enables privileged software
                                               // access to the default memory
                                               // map
...
#define NVIC_MPU_RNR_REGION_M     0xFFU        // MPU region referred by the
...
#define NVIC_MPU_RASR_SIZE_M      0x3EU        // Specifies the size of the MPU
                                               // protection region.
...
#define NVIC_MPU_RASR_XN          0x10000000U  // Instruction access disable
                                               // bit
...
#define NVIC_MPU_RASR_A1_SIZE_M   0x3EU        // Specifies the size of the MPU
                                               // protection region.
...
#define NVIC_MPU_RASR_A1_XN       0x10000000U  // Instruction access disable
                                               // bit
...
#define NVIC_MPU_RASR_A2_SIZE_M   0x3EU        // Specifies the size of the MPU
                                               // protection region.
...
#define NVIC_MPU_RASR_A2_XN       0x10000000U  // Instruction access disable
                                               // bit
...
#define NVIC_MPU_RASR_A3_SIZE_M   0x3EU        // Specifies the size of the MPU
                                               // protection region.
...
#define NVIC_MPU_RASR_A3_XN       0x10000000U  // Instruction access disable
                                               // bit
#endif
