...
#define UART_O_RSR                0x4U         // UART Receive Status/Error
                                               // Clear
#define UART_O_FR                 0x18U        // UART Flag
#define UART_O_ILPR               0x20U        // UART IrDA Low-Power Register
#define UART_O_IBRD               0x24U        // UART Integer Baud-Rate
                                               // Divisor
#define UART_O_FBRD               0x28U        // UART Fractional Baud-Rate
                                               // Divisor
#define UART_O_LCRH               0x2CU        // UART Line Control
#define UART_O_CTL                0x30U        // UART Control
#define UART_O_IFLS               0x34U        // UART Interrupt FIFO Level
                                               // Select
...
#define UART_O_PERIPHID4          0xFD0U       // UART Peripheral
                                               // Identification 4
#define UART_O_PERIPHID5          0xFD4U       // UART Peripheral
                                               // Identification 5
#define UART_O_PERIPHID6          0xFD8U       // UART Peripheral
                                               // Identification 6
#define UART_O_PERIPHID7          0xFDCU       // UART Peripheral
                                               // Identification 7
#define UART_O_PERIPHID0          0xFE0U       // UART Peripheral
                                               // Identification 0
#define UART_O_PERIPHID1          0xFE4U       // UART Peripheral
                                               // Identification 1
#define UART_O_PERIPHID2          0xFE8U       // UART Peripheral
                                               // Identification 2
#define UART_O_PERIPHID3          0xFECU       // UART Peripheral
                                               // Identification 3
#define UART_O_PCELLID0           0xFF0U       // UART PrimeCell Identification
                                               // 0
#define UART_O_PCELLID1           0xFF4U       // UART PrimeCell Identification
                                               // 1
#define UART_O_PCELLID2           0xFF8U       // UART PrimeCell Identification
                                               // 2
#define UART_O_PCELLID3           0xFFCU       // UART PrimeCell Identification
                                               // 3
...
#define UART_IFLS_TXIFLSEL_M      0x7U         // UART Transmit Interrupt FIFO
                                               // Level Select
#define UART_IFLS_RXIFLSEL_S      3U
#define UART_IFLS_RXIFLSEL_M      0x38U        // UART Receive Interrupt FIFO
                                               // Level Select
...
#define UART_IM_RTIM              0x40U        // UART Receive Time-Out
                                               // Interrupt Mask
#define UART_IM_FEIM              0x80U        // UART Framing Error Interrupt
                                               // Mask
#define UART_IM_PEIM              0x100U       // UART Parity Error Interrupt
                                               // Mask
#define UART_IM_BEIM              0x200U       // UART Break Error Interrupt
                                               // Mask
#define UART_IM_OEIM              0x400U       // UART Overrun Error Interrupt
                                               // Mask
#define UART_IM_EOTIM             0x800U       // End of Transmission Interrupt
                                               // Mask
...
//
//*****************************************************************************
#define UART_RIS_RXRIS            0x10U        // UART Receive Raw Interrupt
                                               // Status
#define UART_RIS_TXRIS            0x20U        // UART Transmit Raw Interrupt
                                               // Status
#define UART_RIS_RTRIS            0x40U        // UART Receive Time-Out Raw
                                               // Interrupt Status
#define UART_RIS_FERIS            0x80U        // UART Framing Error Raw
                                               // Interrupt Status
#define UART_RIS_PERIS            0x100U       // UART Parity Error Raw
                                               // Interrupt Status
#define UART_RIS_BERIS            0x200U       // UART Break Error Raw
                                               // Interrupt Status
#define UART_RIS_OERIS            0x400U       // UART Overrun Error Raw
                                               // Interrupt Status
#define UART_RIS_EOTRIS           0x800U       // End of Transmission Raw
                                               // Interrupt Status
#define UART_RIS_9BITRIS          0x1000U      // 9-Bit Mode Raw Interrupt
                                               // Status
#define UART_RIS_DMARXRIS         0x10000U     // Receive DMA Raw Interrupt
                                               // Status
#define UART_RIS_DMATXRIS         0x20000U     // Transmit DMA Raw Interrupt
                                               // Status
...
//
//*****************************************************************************
#define UART_MIS_RXMIS            0x10U        // UART Receive Masked Interrupt
                                               // Status
#define UART_MIS_TXMIS            0x20U        // UART Transmit Masked
                                               // Interrupt Status
#define UART_MIS_RTMIS            0x40U        // UART Receive Time-Out Masked
                                               // Interrupt Status
#define UART_MIS_FEMIS            0x80U        // UART Framing Error Masked
                                               // Interrupt Status
#define UART_MIS_PEMIS            0x100U       // UART Parity Error Masked
                                               // Interrupt Status
#define UART_MIS_BEMIS            0x200U       // UART Break Error Masked
                                               // Interrupt Status
#define UART_MIS_OEMIS            0x400U       // UART Overrun Error Masked
                                               // Interrupt Status
#define UART_MIS_EOTMIS           0x800U       // End of Transmission Masked
                                               // Interrupt Status
#define UART_MIS_9BITMIS          0x1000U      // 9-Bit Mode Masked Interrupt
                                               // Status
#define UART_MIS_DMARXMIS         0x10000U     // Receive DMA Masked Interrupt
                                               // Status
#define UART_MIS_DMATXMIS         0x20000U     // Transmit DMA Masked Interrupt
                                               // Status
...
#define UART_ICR_RTIC             0x40U        // Receive Time-Out Interrupt
                                               // Clear
...
#define UART_ICR_EOTIC            0x800U       // End of Transmission Interrupt
                                               // Clear
...
#define UART_9BITAMASK_MASK_M     0xFFU        // Self Address Mask for 9-Bit
                                               // Mode
...
#define UART_PERIPHID4_PID4_M     0xFFU        // UART Peripheral ID Register
                                               // [7:0]
...
#define UART_PERIPHID5_PID5_M     0xFFU        // UART Peripheral ID Register
                                               // [15:8]
...
#define UART_PERIPHID6_PID6_M     0xFFU        // UART Peripheral ID Register
                                               // [23:16]
...
#define UART_PERIPHID7_PID7_M     0xFFU        // UART Peripheral ID Register
                                               // [31:24]
...
#define UART_PERIPHID0_PID0_M     0xFFU        // UART Peripheral ID Register
                                               // [7:0]
...
#define UART_PERIPHID1_PID1_M     0xFFU        // UART Peripheral ID Register
                                               // [15:8]
...
#define UART_PERIPHID2_PID2_M     0xFFU        // UART Peripheral ID Register
                                               // [23:16]
...
#define UART_PERIPHID3_PID3_M     0xFFU        // UART Peripheral ID Register
                                               // [31:24]
...
#define UART_PCELLID0_CID0_M      0xFFU        // UART PrimeCell ID Register
                                               // [7:0]
...
#define UART_PCELLID1_CID1_M      0xFFU        // UART PrimeCell ID Register
                                               // [15:8]
...
#define UART_PCELLID2_CID2_M      0xFFU        // UART PrimeCell ID Register
                                               // [23:16]
...
#define UART_PCELLID3_CID3_M      0xFFU        // UART PrimeCell ID Register
                                               // [31:24]
