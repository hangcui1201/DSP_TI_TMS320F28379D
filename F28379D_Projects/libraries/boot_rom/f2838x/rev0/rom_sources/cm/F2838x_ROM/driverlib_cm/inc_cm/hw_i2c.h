...
#define I2C_O_MRIS                0x14U        // I2C Master Raw Interrupt
                                               // Status
#define I2C_O_MMIS                0x18U        // I2C Master Masked Interrupt
                                               // Status
#define I2C_O_MICR                0x1CU        // I2C Master Interrupt Clear
#define I2C_O_MCR                 0x20U        // I2C Master Configuration
#define I2C_O_MCLKOCNT            0x24U        // I2C Master Clock Low Timeout
                                               // Count
...
#define I2C_O_SRIS                0x810U       // I2C Slave Raw Interrupt
                                               // Status
#define I2C_O_SMIS                0x814U       // I2C Slave Masked Interrupt
                                               // Status
...
#define I2C_MTPR_PULSEL_M         0x70000U     // Glitch Suppression Pulse
                                               // Width
...
#define I2C_MIMR_NACKIM           0x10U        // Address/Data NACK Interrupt
                                               // Mask
#define I2C_MIMR_STARTIM          0x20U        // START Detection Interrupt
                                               // Mask
#define I2C_MIMR_STOPIM           0x40U        // STOP Detection Interrupt Mask
#define I2C_MIMR_ARBLOSTIM        0x80U        // Arbitration Lost Interrupt
                                               // Mask
#define I2C_MIMR_TXIM             0x100U       // Transmit FIFO Request
                                               // Interrupt Mask
#define I2C_MIMR_RXIM             0x200U       // Receive FIFO Request
                                               // Interrupt Mask
#define I2C_MIMR_TXFEIM           0x400U       // Transmit FIFO Empty Interrupt
                                               // Mask
#define I2C_MIMR_RXFFIM           0x800U       // Receive FIFO Full Interrupt
                                               // Mask
...
#define I2C_MRIS_CLKRIS           0x2U         // Clock Timeout Raw Interrupt
                                               // Status
#define I2C_MRIS_DMARXRIS         0x4U         // Receive DMA Raw Interrupt
                                               // Status
#define I2C_MRIS_DMATXRIS         0x8U         // Transmit DMA Raw Interrupt
                                               // Status
#define I2C_MRIS_NACKRIS          0x10U        // Address/Data NACK Raw
                                               // Interrupt Status
#define I2C_MRIS_STARTRIS         0x20U        // START Detection Raw Interrupt
                                               // Status
#define I2C_MRIS_STOPRIS          0x40U        // STOP Detection Raw Interrupt
                                               // Status
#define I2C_MRIS_ARBLOSTRIS       0x80U        // Arbitration Lost Raw
                                               // Interrupt Status
#define I2C_MRIS_TXRIS            0x100U       // Transmit Request Raw
                                               // Interrupt Status
#define I2C_MRIS_RXRIS            0x200U       // Receive FIFO Request Raw
                                               // Interrupt Status
#define I2C_MRIS_TXFERIS          0x400U       // Transmit FIFO Empty Raw
                                               // Interrupt Status
#define I2C_MRIS_RXFFRIS          0x800U       // Receive FIFO Full Raw
                                               // Interrupt Status
...
#define I2C_MMIS_CLKMIS           0x2U         // Clock Timeout Masked
                                               // Interrupt Status
#define I2C_MMIS_DMARXMIS         0x4U         // Receive DMA Interrupt Status
#define I2C_MMIS_DMATXMIS         0x8U         // Transmit DMA Interrupt Status
#define I2C_MMIS_NACKMIS          0x10U        // Address/Data NACK Interrupt
                                               // Mask
#define I2C_MMIS_STARTMIS         0x20U        // START Detection Interrupt
                                               // Mask
#define I2C_MMIS_STOPMIS          0x40U        // STOP Detection Interrupt Mask
#define I2C_MMIS_ARBLOSTMIS       0x80U        // Arbitration Lost Interrupt
                                               // Mask
#define I2C_MMIS_TXMIS            0x100U       // Transmit Request Interrupt
                                               // Mask
#define I2C_MMIS_RXMIS            0x200U       // Receive FIFO Request
                                               // Interrupt Mask
#define I2C_MMIS_TXFEMIS          0x400U       // Transmit FIFO Empty Interrupt
                                               // Mask
#define I2C_MMIS_RXFFMIS          0x800U       // Receive FIFO Full Interrupt
                                               // Mask
...
#define I2C_MICR_NACKIC           0x10U        // Address/Data NACK Interrupt
                                               // Clear
#define I2C_MICR_STARTIC          0x20U        // START Detection Interrupt
                                               // Clear
#define I2C_MICR_STOPIC           0x40U        // STOP Detection Interrupt
                                               // Clear
#define I2C_MICR_ARBLOSTIC        0x80U        // Arbitration Lost Interrupt
                                               // Clear
#define I2C_MICR_TXIC             0x100U       // Transmit FIFO Request
                                               // Interrupt Clear
#define I2C_MICR_RXIC             0x200U       // Receive FIFO Request
                                               // Interrupt Clear
#define I2C_MICR_TXFEIC           0x400U       // Transmit FIFO Empty Interrupt
                                               // Clear
#define I2C_MICR_RXFFIC           0x800U       // Receive FIFO Full Interrupt
                                               // Clear
...
#define I2C_SIMR_STARTIM          0x2U         // Start Condition Interrupt
                                               // Mask
...
#define I2C_SIMR_TXIM             0x20U        // Transmit FIFO Request
                                               // Interrupt Mask
#define I2C_SIMR_RXIM             0x40U        // Receive FIFO Request
                                               // Interrupt Mask
#define I2C_SIMR_TXFEIM           0x80U        // Transmit FIFO Empty Interrupt
                                               // Mask
#define I2C_SIMR_RXFFIM           0x100U       // Receive FIFO Full Interrupt
                                               // Mask
...
#define I2C_SRIS_STARTRIS         0x2U         // Start Condition Raw Interrupt
                                               // Status
#define I2C_SRIS_STOPRIS          0x4U         // Stop Condition Raw Interrupt
                                               // Status
#define I2C_SRIS_DMARXRIS         0x8U         // Receive DMA Raw Interrupt
                                               // Status
#define I2C_SRIS_DMATXRIS         0x10U        // Transmit DMA Raw Interrupt
                                               // Status
#define I2C_SRIS_TXRIS            0x20U        // Transmit Request Raw
                                               // Interrupt Status
#define I2C_SRIS_RXRIS            0x40U        // Receive FIFO Request Raw
                                               // Interrupt Status
#define I2C_SRIS_TXFERIS          0x80U        // Transmit FIFO Empty Raw
                                               // Interrupt Status
#define I2C_SRIS_RXFFRIS          0x100U       // Receive FIFO Full Raw
                                               // Interrupt Status
...
#define I2C_SMIS_STARTMIS         0x2U         // Start Condition Masked
                                               // Interrupt Status
#define I2C_SMIS_STOPMIS          0x4U         // Stop Condition Masked
                                               // Interrupt Status
#define I2C_SMIS_DMARXMIS         0x8U         // Receive DMA Masked Interrupt
                                               // Status
#define I2C_SMIS_DMATXMIS         0x10U        // Transmit DMA Masked Interrupt
                                               // Status
#define I2C_SMIS_TXMIS            0x20U        // Transmit FIFO Request
                                               // Interrupt Mask
#define I2C_SMIS_RXMIS            0x40U        // Receive FIFO Request
                                               // Interrupt Mask
#define I2C_SMIS_TXFEMIS          0x80U        // Transmit FIFO Empty Interrupt
                                               // Mask
#define I2C_SMIS_RXFFMIS          0x100U       // Receive FIFO Full Interrupt
                                               // Mask
...
#define I2C_SICR_STARTIC          0x2U         // Start Condition Interrupt
                                               // Clear
#define I2C_SICR_STOPIC           0x4U         // Stop Condition Interrupt
                                               // Clear
#define I2C_SICR_DMARXIC          0x8U         // Receive DMA Interrupt Clear
#define I2C_SICR_DMATXIC          0x10U        // Transmit DMA Interrupt Clear
#define I2C_SICR_TXIC             0x20U        // Transmit Request Interrupt
                                               // Mask
#define I2C_SICR_RXIC             0x40U        // Receive Request Interrupt
                                               // Mask
#define I2C_SICR_TXFEIC           0x80U        // Transmit FIFO Empty Interrupt
                                               // Mask
#define I2C_SICR_RXFFIC           0x100U       // Receive FIFO Full Interrupt
                                               // Mask
...
#define I2C_SOAR2_OAR2EN          0x80U        // I2C Slave Own Address 2
                                               // Enable
