...
// Eg. To get a transmit interrupt after 4 data bytes are transmitted we need 
// a trigger after the transmit FIFO has 4 bytes with 4 locations deep
// ie.4 out of 16 locations deep which is 1/4 full.(UART_FIFO_TX2_8)
//
//*****************************************************************************
...
// These are 8 bit ( 1 byte) wide and 16 locations deep FIFOs.
// Eg. To get a receive interrupt after 4 data bytes are received, we need 
// a trigger after the receive FIFO has 4 bytes with 4 locations deep
// ie.4 out of 16 locations deep which is 1/4 full.(UART_FIFO_RX2_8)
//
//*****************************************************************************
...
//*****************************************************************************
//
//! Sends an data character from the specified port when operating in 9-bit
//! mode.
//!
//! \param base is the base address of the UART port.
...
//!
//! This function waits until all data has been sent from the specified port
//! and then sends the given data as an data byte.  It then waits until
//! the data byte has been transmitted before returning.
//!
//! \return None.
//
//*****************************************************************************
extern void UART_send9BitData(uint32_t base, uint8_t data);
