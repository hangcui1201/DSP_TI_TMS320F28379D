...
typedef enum
{
  I2C_MASTER_CMD_SINGLE_SEND                   = 0x00000007U, //!<SINGLE SEND
  I2C_MASTER_CMD_SINGLE_RECEIVE                = 0x00000007U, //!<SINGLE RECV
  I2C_MASTER_CMD_BURST_SEND_START              = 0x00000003U, //!<BURST SEND START                                                          
  I2C_MASTER_CMD_BURST_SEND_CONT               = 0x00000001U, //!<BURST SEND CONT
  I2C_MASTER_CMD_BURST_SEND_FINISH             = 0x00000005U, //!<BURST SEND FINISH
  I2C_MASTER_CMD_BURST_SEND_STOP               = 0x00000004U, //!<BURST SEND STOP
  I2C_MASTER_CMD_BURST_SEND_ERROR_STOP         = 0x00000004U, //!<BURST SEND ERROR_STOP
  I2C_MASTER_CMD_BURST_RECEIVE_START           = 0x0000000bU, //!<BURST RECEIVE START
  I2C_MASTER_CMD_BURST_RECEIVE_CONT            = 0x00000009U, //!<BURST RECEIVE CONT
  I2C_MASTER_CMD_BURST_RECEIVE_FINISH          = 0x00000005U, //!<BURST RECEIVE FINISH
  I2C_MASTER_CMD_BURST_RECEIVE_ERROR_STOP      = 0x00000004U, //!<BURST RECEIVE ERROR STOP
  I2C_MASTER_CMD_QUICK_COMMAND                 = 0x00000027U, //!<QUICK COMMAND
  I2C_MASTER_CMD_HS_MASTER_CODE_SEND           = 0x00000013U, //!<HS MASTER CODE SEND
  I2C_MASTER_CMD_FIFO_SINGLE_SEND              = 0x00000046U, //!<FIFO SINGLE SEND 
  I2C_MASTER_CMD_FIFO_SINGLE_RECEIVE           = 0x00000046U, //!<FIFO SINGLE RECEIVE
  I2C_MASTER_CMD_FIFO_BURST_SEND_START         = 0x00000042U, //!<FIFO BURST SEND START
  I2C_MASTER_CMD_FIFO_BURST_SEND_CONT          = 0x00000040U, //!<FIFO BURST SEND CONT
  I2C_MASTER_CMD_FIFO_BURST_SEND_FINISH        = 0x00000044U, //!<FIFO BURST SEND FINISH
  I2C_MASTER_CMD_FIFO_BURST_SEND_ERROR_STOP    = 0x00000004U, //!<BURST SEND ERROR STOP
  I2C_MASTER_CMD_FIFO_BURST_RECEIVE_START      = 0x0000004aU, //!<BURST RECEIVE START
  I2C_MASTER_CMD_FIFO_BURST_RECEIVE_CONT       = 0x00000048U, //!<BURST RECEIVE CONT
  I2C_MASTER_CMD_FIFO_BURST_RECEIVE_FINISH     = 0x00000044U, //!<FIFO BURST RECEIVE FINISH
  I2C_MASTER_CMD_FIFO_BURST_RECEIVE_ERROR_STOP = 0x00000004U  //!<FIFO BURST RECEIVE ERROR STOP
...
//!
//! \param base is the base address of the I2C module.
//! \param bMasked of type I2C_MasterIntType is I2C_MASTER_RAW_INT 
//! if the raw interrupt status is requested and I2C_MASTER_MASKED_INT
//! if the masked interrupt status is requested.
//!
//! This function returns the interrupt status for the I2C Slave.
...
//!
//! \param base is the base address of the I2C module.
//! \param pdata is a pointer where the read data is stored.
//!
//! This function reads a byte of data from I2C receive FIFO and places it in
//! the location specified by the \e pdata parameter.  If there is no data
