...
//
//*****************************************************************************
#define SYSCTL_O_CMPCLKCR0        0x0U         // CM Peripheral clock gating
                                               // register 0.
#define SYSCTL_O_CMPCLKCR1        0x4U         // CM Peripheral clock gating
                                               // register 1.
#define SYSCTL_O_CMPCLKCR2        0x8U         // CM Peripheral clock gating
                                               // register 2.
#define SYSCTL_O_CMSOFTPRESET0    0x20U        // CM Software Peripheral Reset
                                               // register 0
#define SYSCTL_O_CMSOFTPRESET1    0x24U        // CM Software Peripheral Reset
                                               // register 1
#define SYSCTL_O_CMSOFTPRESET2    0x28U        // CM Software Peripheral Reset
                                               // register 2
#define SYSCTL_O_CMCLKSTOPREQ0    0x40U        // Peripheral Clock Stop Request
                                               // Register 0
#define SYSCTL_O_CMCLKSTOPREQ1    0x44U        // Peripheral Clock Stop Request
                                               // Register 1
#define SYSCTL_O_CMCLKSTOPREQ2    0x48U        // Peripheral Clock Stop Request
                                               // Register 2
#define SYSCTL_O_CMCLKSTOPACK1    0x64U        // Peripheral Clock Stop
                                               // Ackonwledge Register 1
#define SYSCTL_O_MCANWAKESTATUS   0xE0U        // MCAN Wake Status Register
#define SYSCTL_O_MCANWAKESTATUSCLR  0xE4U        // MCAN Wake Status Clear
                                               // Register
#define SYSCTL_O_CMECATCTL        0x100U       // CM etherCAT control register
#define SYSCTL_O_PALLOCATESTS     0x1F4U       // Status of PALLOCATE register.
#define SYSCTL_O_CMRESCCLR        0x1F8U       // CM Reset Cause Status Clear
                                               // Register
#define SYSCTL_O_CMRESC           0x1FCU       // CM Reset Cause Status
                                               // Register
#define SYSCTL_O_CMSYSCTLLOCK     0x200U       // Locks the configuration
                                               // registers of CM System control
...
//
//*****************************************************************************
#define SYSCTL_CMPCLKCR2_CPUTIMER1  0x1U         // CPUTIMER1 Clock gating Bit
#define SYSCTL_CMPCLKCR2_CPUTIMER2  0x2U         // CPUTIMER2 Clock gating Bit
#define SYSCTL_CMPCLKCR2_CPUTIMER3  0x4U         // CPUTIMER3 Clock gating Bit
...
//*****************************************************************************
//
// The following are defines for the bit fields in the CMECATCTL register
//
//*****************************************************************************
#define SYSCTL_CMECATCTL_I2CLOOPBACK  0x1U         // Loopback I2C port of etherCAT
                                               // IP to CM I2C.
...
#define SYSCTL_PALLOCATESTS_ETHERCAT  0x2U         // Status of PALLOCATE.ETHERCAT
                                               // bit
...
#define SYSCTL_PALLOCATESTS_MCAN_A  0x10U        // Status of PALLOCATE.MCAN_A
                                               // bit
...
//
//*****************************************************************************
#define SYSCTL_CMRESCCLR_PORN     0x1U         // PORn status flag clear
...
#define SYSCTL_CMRESCCLR_CPU1NMIWDRSN  0x8U         // CPU1NMIWDRSn status flag
                                               // clear
#define SYSCTL_CMRESCCLR_CPU1SYSRSN  0x10U        // CPU1SYSRSN status flag clear
#define SYSCTL_CMRESCCLR_CPU1SCCRESETN  0x20U        // CPU1SCCRESETn status flag
                                               // clear
#define SYSCTL_CMRESCCLR_ECAT_RESET_OUT  0x40U        // ECAT_RESET_OUT status flag
                                               // clear
#define SYSCTL_CMRESCCLR_CPU1SIMRESET_CPURSN  0x80U        // CPU1SIMRESET_CPURSn status
                                               // flag clear
#define SYSCTL_CMRESCCLR_CMRSTCTLRESETREQ  0x100U       // CMRSTCTLRESETREQ status flag
                                               // clear
#define SYSCTL_CMRESCCLR_CMVECTRESETN  0x10000U     // CMVECTRESETn status flag
                                               // clear
#define SYSCTL_CMRESCCLR_CMSYSRESETREQ  0x20000U     // CMSYSRESETREQ status flag
                                               // clear
...
//
//*****************************************************************************
#define SYSCTL_CMRESC_POR        0x1U         // PORn caused the reset of CM
#define SYSCTL_CMRESC_XRSN        0x2U         // XRSn caused the reset of CM
#define SYSCTL_CMRESC_CPU1_WDRSN  0x4U         // CPU1_WDRSn caused the reset
                                               // of CM
#define SYSCTL_CMRESC_CPU1_NMIWDRSN  0x8U         // CPU1_NMIWDRSn caused the
                                               // reset of CM
#define SYSCTL_CMRESC_CPU1_SYSRSN  0x10U        // CPU1_SYSRSN caused the reset
                                               // of CM
#define SYSCTL_CMRESC_CPU1_SCCRESETN  0x20U        // CPU1_SCCRESETn caused the
                                               // reset of CM
#define SYSCTL_CMRESC_ECAT_RESET_OUT  0x40U        // ECAT_RESET_OUT caused the
                                               // reset of CM
#define SYSCTL_CMRESC_CPU1_SIMRESET_CPURSN  0x80U        // CPU1_SIMRESET_CPURSn caused
                                               // the reset of CM
#define SYSCTL_CMRESC_CMRSTCTL_RESETREQ  0x100U       // CMRSTCTL_RESETREQ caused the
                                               // reset of CM
#define SYSCTL_CMRESC_CMVECTRESETN  0x10000U     // CMVECTRESETn caused the reset
                                               // of CM
#define SYSCTL_CMRESC_CMSYSRESETREQ  0x20000U     // CMSYSRESETREQ caused the
                                               // reset of CM
#define SYSCTL_CMRESC_CMNMIWDRSTN  0x40000U     // CMNMIWDRSTn caused the reset
                                               // of CM
#define SYSCTL_CMRESC_CMEOLRESETN  0x80000U     // CMEOLRESETn caused the reset
                                               // of CM
...
//
//*****************************************************************************
#define SYSCTL_CMSYSCTLLOCK_LOCK  0x1U         // Locks the configuration
                                               // registers of CM System Control
#endif
