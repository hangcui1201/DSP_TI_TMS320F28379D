...
//*****************************************************************************
//! Enables deep sleep mode as the low power mode.
//!
//! \param None
//!
//! This function enables deep sleep mode as the low power mode.
//! until the processor returns to run mode.
//!
//! \return None.
//*****************************************************************************
static inline void
Interrupt_enableDeepSleepMode(void)
{
    HWREG(NVIC_BASE + NVIC_O_SCR) |= NVIC_SCR_SLEEPDEEP;
}

//*****************************************************************************
//! Disables deep sleep mode as the low power mode.
//!
//! \param None
//!
//! This function enables deep sleep mode as the low power mode.
...
//*****************************************************************************
static inline void
Interrupt_disableDeepSleepMode(void)
{
    HWREG(NVIC_BASE + NVIC_O_SCR) &= ~NVIC_SCR_SLEEPDEEP;
}

//*****************************************************************************
//! Enables processor wake up by all the interrupts.
//!
//! \param None
//!
//! This function enables processor wake up by all the interrupts i.e both the
//! enables and disabled interrupts.
//!
//! \return None.
//*****************************************************************************
static inline void
Interrupt_enableWakeupOnPend(void)
{
    HWREG(NVIC_BASE + NVIC_O_SCR) |= NVIC_SCR_SEVONPEND;
}

//*****************************************************************************
//! Disables processor wake up by all the interrupts.
//!
//! \param None
//!
//! This function disables processor wake up by all the interrupts i.e only
//! enabled interrupts can wake up the processor.
//!
//! \return None.
//*****************************************************************************
static inline void
Interrupt_disableWakeupOnPend(void)
{
    HWREG(NVIC_BASE + NVIC_O_SCR) &= ~NVIC_SCR_SEVONPEND;
}
...
//!
//! \param base is the base address of the NVIC module.
