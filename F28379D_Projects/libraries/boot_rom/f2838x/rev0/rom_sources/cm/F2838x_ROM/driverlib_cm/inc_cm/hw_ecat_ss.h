...
#define ECAT_SS_O_ECAT_INTR_RIS   0x4U         // EtherCATSS Interrupt Raw
                                               // Status
#define ECAT_SS_O_ECAT_INTR_MASK  0x8U         // EtherCATSS Interrupt Mask
#define ECAT_SS_O_ECAT_INTR_MIS   0xCU         // EtherCATSS Masked Interrupt
                                               // Status
#define ECAT_SS_O_ECAT_INTR_CLR   0x10U        // EtherCATSS Interrupt Clear
#define ECAT_SS_O_ECAT_INTR_SET   0x14U        // EtherCATSS Interrupt Set to
                                               // emulate
#define ECAT_SS_O_ECAT_LATCH_SEL  0x18U        // Select for Latch0/1 inputs
                                               // and LATCHIN input
#define ECAT_SS_O_ECAT_ACCESS_CTRL  0x1CU        // PDI interface access control
                                               // config.
#define ECAT_SS_O_ECAT_GPIN_DAT   0x20U        // GPIN data capture for debug &
                                               // override
#define ECAT_SS_O_ECAT_GPIN_PIPE  0x24U        // GPIN pipeline select
#define ECAT_SS_O_ECAT_GPIN_GRP_CAP_SEL  0x28U        // GPIN pipe group capture
                                               // trigger
#define ECAT_SS_O_ECAT_GPOUT_DAT  0x2CU        // GPOUT data capture for debug
                                               // & override
#define ECAT_SS_O_ECAT_GPOUT_PIPE  0x30U        // GPOUT pipeline select
#define ECAT_SS_O_ECAT_GPOUT_GRP_CAP_SEL  0x34U        // GPOUT pipe group capture
                                               // trigger
#define ECAT_SS_O_ECAT_MEM_TEST   0x38U        // Memory Test Control
#define ECAT_SS_O_ECAT_RESET_DEST_CONFIG  0x3CU        // ResetOut impact or
                                               // destination config
#define ECAT_SS_O_ECAT_SYNC0_CONFIG  0x40U        // SYNC0 Configuration for
                                               // various triggers
#define ECAT_SS_O_ECAT_SYNC1_CONFIG  0x44U        // SYNC1 Configuration for
                                               // various triggers
#define ECAT_SS_O_ECAT_CONFIG_LOCK  0x0U         // EtherCATSS Configuration Lock
#define ECAT_SS_O_ECAT_MISC_IO_CONFIG  0x4U         // RESET_IN, EEPROM IO
                                               // connections select
#define ECAT_SS_O_ECAT_PHY_IO_CONFIG  0x8U         // Control Register of ECATSS
#define ECAT_SS_O_ECAT_SYNC_IO_CONFIG  0xCU         // SYNC Signals IO
                                               // configurations
#define ECAT_SS_O_ECAT_LATCH_IO_CONFIG  0x10U        // LATCH inputs IO pad select
#define ECAT_SS_O_ECAT_GPIN_SEL   0x14U        // GPIN Select between IO PAD &
                                               // tieoff
#define ECAT_SS_O_ECAT_GPIN_IOPAD_SEL  0x18U        // GPIN IO pad Select
#define ECAT_SS_O_ECAT_GPOUT_SEL  0x1CU        // GPOUT IO pad connect select
#define ECAT_SS_O_ECAT_GPOUT_IOPAD_SEL  0x20U        // GPOUT IO pad select
#define ECAT_SS_O_ECAT_LED_CONFIG  0x24U        // Selection of LED o/p connect
                                               // to IO pad
#define ECAT_SS_O_ECAT_MISC_CONFIG  0x28U        // Miscelleneous Configuration
