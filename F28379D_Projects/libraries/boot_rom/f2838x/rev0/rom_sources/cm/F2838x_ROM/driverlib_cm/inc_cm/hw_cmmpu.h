...
#define CMMPU_O_ACC_VIO_INTEN     0x20U        // Access violation interrupt
                                               // enable
#define CMMPU_O_ACC_VIO_FLAGS     0x24U        // Access violation flag
                                               // register
#define CMMPU_O_ACC_VIO_FLAGS_SET  0x28U        // Acesss violation set register
#define CMMPU_O_ACC_VIO_FLAGS_CLR  0x2CU        // Access violation clear
                                               // register
#define CMMPU_O_ACC_VIO_ADDR_REG  0x30U        // Access violation address
                                               // register
#define CMMPU_O_REGION0_STARTADDRESSS  0x40U        // Region 0 start address
                                               // register
#define CMMPU_O_REGION0_CONFIG    0x44U        // Region 0 configuration
                                               // register
#define CMMPU_O_REGION1_STARTADDRESSS  0x48U        // Region 1 start address
                                               // register
#define CMMPU_O_REGION1_CONFIG    0x4CU        // Region 1 configuration
                                               // register
#define CMMPU_O_REGION2_STARTADDRESSS  0x50U        // Region 2 start address
                                               // register
#define CMMPU_O_REGION2_CONFIG    0x54U        // Region 2 configuration
                                               // register
#define CMMPU_O_REGION3_STARTADDRESSS  0x58U        // Region 3 start address
                                               // register
#define CMMPU_O_REGION3_CONFIG    0x5CU        // Region 3 configuration
                                               // register
#define CMMPU_O_REGION4_STARTADDRESSS  0x60U        // Region 4 start address
                                               // register
#define CMMPU_O_REGION4_CONFIG    0x64U        // Region 4 configuration
                                               // register
#define CMMPU_O_REGION5_STARTADDRESSS  0x68U        // Region 5 start address
                                               // register
#define CMMPU_O_REGION5_CONFIG    0x6CU        // Region 5 configuration
                                               // register
#define CMMPU_O_REGION6_STARTADDRESSS  0x70U        // Region 6 start address
                                               // register
#define CMMPU_O_REGION6_CONFIG    0x74U        // Region 6 configuration
                                               // register
#define CMMPU_O_REGION7_STARTADDRESSS  0x78U        // Region 7 start address
                                               // register
#define CMMPU_O_REGION7_CONFIG    0x7CU        // Region 7 configuration
                                               // register
...
//
//*****************************************************************************
#define CMMPU_ACC_VIO_FLAGS_SET_RD  0x1U         // Read access violation flag
                                               // set
#define CMMPU_ACC_VIO_FLAGS_SET_WR  0x2U         // Write access violation flag
                                               // set
...
//
//*****************************************************************************
#define CMMPU_ACC_VIO_FLAGS_CLR_RD  0x1U         // Read access violation flag
                                               // clear
#define CMMPU_ACC_VIO_FLAGS_CLR_WR  0x2U         // Write access violation flag
                                               // clear
...
#define CMMPU_REGION0_CONFIG_PROT_TYPE_M  0x30U        // Access permission
                                               // configuration bits
...
#define CMMPU_REGION1_CONFIG_PROT_TYPE_M  0x30U        // Access permission
                                               // configuration bits
...
#define CMMPU_REGION2_CONFIG_PROT_TYPE_M  0x30U        // Access permission
                                               // configuration bits
...
#define CMMPU_REGION3_CONFIG_PROT_TYPE_M  0x30U        // Access permission
                                               // configuration bits
...
#define CMMPU_REGION4_CONFIG_PROT_TYPE_M  0x30U        // Access permission
                                               // configuration bits
...
#define CMMPU_REGION5_CONFIG_PROT_TYPE_M  0x30U        // Access permission
                                               // configuration bits
...
#define CMMPU_REGION6_CONFIG_PROT_TYPE_M  0x30U        // Access permission
                                               // configuration bits
...
#define CMMPU_REGION7_CONFIG_PROT_TYPE_M  0x30U        // Access permission
                                               // configuration bits
