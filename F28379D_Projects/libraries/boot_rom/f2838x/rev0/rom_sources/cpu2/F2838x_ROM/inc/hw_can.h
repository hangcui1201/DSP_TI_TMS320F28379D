...
#define CAN_O_ECCDIAG             0x24U        // CAN ECC Diagnostic Register
#define CAN_O_ECCDIAG_STAT        0x28U        // CAN ECC Diagnostic Status
                                               // Register
...
#define CAN_O_IO_CTL_TX           0x1E0U       // CAN TX I/O Control Register
#define CAN_O_IO_CTL_RX           0x1E4U       // CAN RX I/O Control Register
...
//*****************************************************************************
//
// The following are defines for the bit fields in the CAN_ECCDIAG register
//
//*****************************************************************************
#define CAN_ECCDIAG_ECCDIAG_S     0U
#define CAN_ECCDIAG_ECCDIAG_M     0xFU         // Diagnostic Enable

//*****************************************************************************
//
// The following are defines for the bit fields in the CAN_ECCDIAG_STAT register
//
//*****************************************************************************
#define CAN_ECCDIAG_STAT_SEFLG    0x1U         // Single bit error flag
#define CAN_ECCDIAG_STAT_DEFLG    0x100U       // Double bit error flag
...
//*****************************************************************************
//
// The following are defines for the bit fields in the CAN_IO_CTL_TX register
//
//*****************************************************************************
#define CAN_IO_CTL_TX_IN          0x1U         // Input value of CAN_TX pin
#define CAN_IO_CTL_TX_FUNC        0x8U         // Functionality of CAN_TX pin

//*****************************************************************************
//
// The following are defines for the bit fields in the CAN_IO_CTL_RX register
//
//*****************************************************************************
#define CAN_IO_CTL_RX_IN          0x1U         // Input value of CAN_RX pin
#define CAN_IO_CTL_RX_FUNC        0x8U         // Functionality of CAN_RX pin
#endif
