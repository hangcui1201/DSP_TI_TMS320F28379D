;;###########################################################################
;;
;; FILE:    cpu2brom_vector_table.asm
;;
;; TITLE:   CPU2 Boot Rom vector table.
;;
...
;----------------------------------------------------------
     .ref InitBoot
     .ref CPU2BROM_nmiHandler
     .ref CPU2BROM_itrapISR
     .ref CPU2BROM_pieVectorMismatchHandler
     .sect ".BootVecs"
      BF CPU2BROM_pieVectorMismatchHandler, UNC  ;pie vect mismatch handler at address 0x3fffbe
     .long InitBoot               ;Reset
     .long 0x000042
     .long 0x000044
     .long 0x000046
     ...
     .long 0x000060
     .long 0x000062
     .long CPU2BROM_nmiHandler    ;NMI
     .long CPU2BROM_itrapISR      ;ITRAP
     .long 0x000068
     .long 0x00006a
     .long 0x00006c
     .long 0x00006e
