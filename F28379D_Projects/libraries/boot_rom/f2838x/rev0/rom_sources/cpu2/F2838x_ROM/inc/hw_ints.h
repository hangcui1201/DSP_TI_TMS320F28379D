...
#define INT_CANA0                   0x00640905U // 9.5 - DCANA Interrupt 0
#define INT_CANA1                   0x00650906U // 9.6 - DCANA Interrupt 1
#define INT_CANB0                   0x00660907U // 9.7 - DCANB Interrupt 0
#define INT_CANB1                   0x00670908U // 9.8 - DCANB Interrupt 1
...
#define INT_FSITXA_INT1             0x00980409U // 4.9 - FSIA Transmit interrupt 1
#define INT_FSITXA_INT2             0x0099040AU // 4.10 - FSIA Transmit interrupt 2
#define INT_FSITXB_INT1             0x009A040BU // 4.11 - FSIB Transmit interrupt 1
#define INT_FSITXB_INT2             0x009B040CU // 4.12 - FSIB Transmit interrupt 2
#define INT_FSIRXA_INT1             0x009C040DU // 4.13 - FSIA Receive interrupt 1
#define INT_FSIRXA_INT2             0x009D040EU // 4.14 - FSIA Receive interrupt 2
#define INT_FSIRXB_INT1             0x009E040FU // 4.15 - FSIB Receive interrupt 1
#define INT_FSIRXB_INT2             0x009F0410U // 4.16 - FSIB Receive interrupt 2
...
#define INT_ECATRSTINTN             0x00A2050BU // 5.11 - ETHERCAT Resetout Interrupt
...
#define INT_FSIRXC_INT1             0x00B00709U // 7.9 - FSIC Receive interrupt 1
#define INT_FSIRXC_INT2             0x00B1070AU // 7.10 - FSIC Receive interrupt 2
#define INT_FSIRXD_INT1             0x00B2070BU // 7.11 - FSID Receive interrupt 1
#define INT_FSIRXD_INT2             0x00B3070CU // 7.12 - FSID Receive interrupt 2
#define INT_FSIRXE_INT1             0x00B4070DU // 7.13 - FSIE Receive interrupt 1
#define INT_FSIRXE_INT2             0x00B5070EU // 7.14 - FSIE Receive interrupt 2
#define INT_FSIRXF_INT1             0x00B6070FU // 7.15 - FSIF Receive interrupt 1
#define INT_FSIRXF_INT2             0x00B70710U // 7.16 - FSIF Receive interrupt 2
#define INT_FSIRXG_INT1             0x00B80809U // 8.9 - FSIG Receive interrupt 1
#define INT_FSIRXG_INT2             0x00B9080AU // 8.10 - FSIG Receive interrupt 2
#define INT_FSIRXH_INT1             0x00BA080BU // 8.11 - FSIH Receive interrupt 1
#define INT_FSIRXH_INT2             0x00BB080CU // 8.12 - FSIH Receive interrupt 2
...
#define INT_MCANSS_INT0             0x00C00909U // 9.9 - MCAN Sub-System Interrupt 0
#define INT_MCANSS_INT1             0x00C1090AU // 9.10 - MCAN Sub-System Interrupt 1
#define INT_MCANSS_ECC_CORR_LVL_INT 0x00C2090BU // 9.11 - MCAN Sub-System ECC error Interrupt
#define INT_MCANSS_WAKE_AND_TS_PLS_INT 0x00C3090CU // 9.12 - MCAN Sub-System wakeup Interrupt
#define INT_PMBUSA                  0x00C4090DU // 9.13 - PMBUSA Interrupt
#define INT_CM_STATUS_INT           0x00C5090EU // 9.14 - CM Reset Status Interrupt
...
#define INT_CMTOCPUIPCINTR0         0x00D00B09U // 11.9 - CM to CPU IPC Interrupt 1
#define INT_CMTOCPUIPCINTR1         0x00D10B0AU // 11.10 - CM to CPU IPC Interrupt 2
#define INT_CMTOCPUIPCINTR2         0x00D20B0BU // 11.11 - CM to CPU IPC Interrupt 3
#define INT_CMTOCPUIPCINTR3         0x00D30B0CU // 11.12 - CM to CPU IPC Interrupt 4
#define INT_CMTOCPUIPCINTR4         0x00D40B0DU // 11.13 - CM to CPU IPC Interrupt 5
#define INT_CMTOCPUIPCINTR5         0x00D50B0EU // 11.14 - CM to CPU IPC Interrupt 6
#define INT_CMTOCPUIPCINTR6         0x00D60B0FU // 11.15 - CM to CPU IPC Interrupt 7
#define INT_CMTOCPUIPCINTR7         0x00D70B10U // 11.16 - CM to CPU IPC Interrupt 8
#define INT_ECAP6INT2               0x00D90C0AU // 12.10 - eCAP6 Interrupt 2
#define INT_ECAP7INT2               0x00DA0C0BU // 12.11 - eCAP7 Interrupt 2
#define INT_CPUCRC_INT              0x00DC0C0DU // 12.13 - CPU BGCRC module interrupt
#define INT_CLA1CRC_INT             0x00DD0C0EU // 12.14 - CLA1 BGCRC module interrupt
