...
//
// a tolerance of 2.0e-6 represented in IEEE754 format is
// 1.048576 * 2^-19, so the mantissa is roughly accurate to 19 bits
// Therefore, there may be error in the 32-19 = 13 LSbs
// uint32_t toleranceLSBMantissa = (1UL << 13);
//
// VC160916>>
